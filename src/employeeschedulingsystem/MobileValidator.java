...
public class MobileValidator implements StringValidator{
    ...
    public boolean isValid(String mobile) {
        // mobile can be empty when read in, but has to be converted to null when making new employee (thus allow empty string here)
        return "".equals(mobile)||validMobileNonEmpty(mobile);
    }

    /**
     * checks validity. The stricter version - doesn't allow empty
     * @param mobile
     * @return
     */
    public static boolean validMobileNonEmpty(String mobile){
