 ...
 * 
 * Objects of this class must not be changed, since AvailabilityLoader needs to go in a set
 */
public abstract class TimePeriodLoader {
    /**
     * start time of the availability
     */
    @CsvCustomBindByName(converter = DateTimeCsvConverter.class, required = true)
