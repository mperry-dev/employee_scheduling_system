...
public class DateTimeCsvLoaderTest {
    private DateTimeCsvLoader loader;

    @BeforeEach
    public void before(){
        loader = new DateTimeCsvLoader();
    }
    ...
    public void testNullDateTime(){
        assertThrows(IllegalArgumentException.class, ()->{DateTimeCsvLoader.convertDateTimeToString(null);});
    }
    ...
    public void testValidDateTimeToStrings(DateTime dt, String s){
        assertEquals(s, DateTimeCsvLoader.convertDateTimeToString(dt));
    }
    ...
    public void testValidStringPairedWithDateTimeParametersNonSymmetricCases(String s, DateTime dt){
        assertNotEquals(s, DateTimeCsvLoader.convertDateTimeToString(dt));
    }
